...
/***/ "./src/Basics/A0019-exercise/form-control.ts":
/*!***************************************************!*\
  !*** ./src/Basics/A0019-exercise/form-control.ts ***!
  \***************************************************/
...
const checkHasEmptyFields = (...inputs) => {
...
const checkEmailIsValid = (input) => {
    if (input.value && !(0, isEmail_1.default)(input.value)) {
        showErrorMessage(input, 'Email inválido!');
        return false;
    }
    return true;
};
const checkIfPasswordsEquals = (...passwordInputs) => {
...
/*!*****************************************************!*\
  !*** ./src/Basics/A0019-exercise/A0019-exercise.ts ***!
  \*****************************************************/

Object.defineProperty(exports, "__esModule", ({ value: true }));
__webpack_require__(/*! ./form-control */ "./src/Basics/A0019-exercise/form-control.ts");
